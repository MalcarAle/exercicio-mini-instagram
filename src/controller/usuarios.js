...
const cadastraUsuario = async (req, res) => {
  ...
  try {
    ...
    if (!usuario) {
      return res.status(400).json("O usuario não foi cadastro!")
    }
...
const atualizaPerfil = async (req, res) => {
  ...
  if (
    ...
    return res
      .status(404)
      .json("Obrigatório informar todos os campos para atualização")
  }
...
module.exports = { cadastraUsuario, obterPerfil, atualizaPerfil }
